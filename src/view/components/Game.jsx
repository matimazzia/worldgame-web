...
export const Game = () => {
  ...
  return (
    <div className={`flex flex-col h-full items-center justify-center`}>
      <div className={`flex items-center justify-center rounded-lg`}>
        ...
        >
          <div className={`flex items-center justify-center mt-35`}>
            <div
              className={`flex items-center justify-center bg-[#C0D6DF] rounded-lg w-80 h-90`}
            >
              <h2
                className={`text-lg shadow-lg font-bold text-center mt-2 mb--2`}
              >
                {dataModal[0]?.name}
              </h2>
              <div
                className={`h-4/10 w-8/10 flex flex-row items-center justify-evenly`}
              >
                <div
                  className={`flex flex-col justify-center items-center h-25 w-22 ${
                ...
                >
                  ...
                  <h2 className={`mb-0.5 mt-0.5 font-bold text-sm`}>
                    {isSpanish ? "Hemisferio" : "Hemisphere"}
                  </h2>
                  <h2 className={`text-sm`}>
                    {" "}
                    {dataModal[0]?.hemisphere?.hemisphere
                      ? dataModal[0]?.hemisphere?.hemisphere == "South"
                        ? isSpanish
                          ? "Sur"
                          : "South"
                        : isSpanish
                        ? "Norte"
                        : "North"
                      : dataModal[0]?.hemisphere?.tryHemisphere == "South"
                      ? isSpanish
                        ? "Sur"
                        : "South"
                      : isSpanish
                ...
                >
                  ...
                  <h2 className={`text-sm text-center`}>
                    ...
                    {dataModal[0]?.continent?.tryCont
                      ...
                      : translateRegion(
                          dataModal[0]?.continent?.continent
                        )}{" "}
                  </h2>
                </div>
                <div
              ...
              >
                <div
                  className={`flex flex-col justify-center items-center h-25 w-25 ${
                ...
                >
                  ...
                  <h2 className={`text-sm`}>
                    {" "}
                    {isSpanish
                      ? dataModal[0]?.coordinates?.direction.replace("W", "O")
                      : dataModal[0]?.coordinates?.direction}{" "}
                  </h2>
                </div>
              </div>
              <div
              ...
              >
                <div
                  className={`w-60 mb-2 mt-1 border-b border-solid border-gray-400`}
                ></div>
                <button
      ...
      {listOfAttemps?.map((el) => {
        return (
          <div key={el.name} className={`flex flex-col`}>
            ...
            >
              <h2 className={`mt-2 text-center text-white font-bold text-lg`}>
                {el.name}
              </h2>
              <div
                key={el.name}
                className={`flex flex-row justify-center items-center mb-3 mt-3`}
              >
                <div
                ...
                >
                  <div>
                    <TbWorld fontSize="1.8em" color="white"/>
                  </div>
                </div>
                <div
                  className={`flex justify-center items-center ${
                ...
                >
                  <div>
                    <BiWorld fontSize="1.8em" color="white"/>
                  </div>
                </div>
                <div
                  className={`flex justify-center items-center ${
                ...
                >
                  <div>
                    <BiArea fontSize="1.8em" color="white"/>
                  </div>
                </div>
                <div
                  className={`flex justify-center items-center ${
                ...
                >
                  <div>
                    <IoMdPeople fontSize="1.8em" color="white"/>
                  </div>
                </div>
                <div
                  className={`flex justify-center items-center ${
                ...
                >
                  <div>
                    <FaCompass fontSize="1.8em" color="white"/>
                  </div>
                </div>
              </div>
            </button>
      ...
      {display === true ? (
        <h2 className={`mt-2 text-center text-white font-bold text-xl`}>
          {isSpanish ? "El país era: " : "The country was: "}
          {countryOfGame.name}
        </h2>
      ) : (
        <></>
